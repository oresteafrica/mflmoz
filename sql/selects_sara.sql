...
Posto de Saúde 				27
Centro de Saúde Rural Ii 	2
Centro de Saúde Urbano A 	4
Centro de Saúde Urbano B 	3
Centro de Saúde Urbano C 	2
Hospital Rural 				7
...
Hospital Central 			1
Hospital Privado 			2
Farmácia Pública Privada 	1
Farmácia Privada 			2

//--------------------------------------------

SELECT (SELECT unit_service.name FROM unit_service WHERE unit_service.id 
	IN ( SELECT from_field_1.mz023_c FROM from_field_1 ) ) AS Serviços 
FROM from_field_1 

SELECT unit_service.name FROM unit_service 
WHERE unit_service.id IN 

SELECT from_field_1.mz023_c FROM from_field_1
